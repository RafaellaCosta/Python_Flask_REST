...
class ListaEnsaios(Resource):
    ...
    def get(self):
        ...
        response = [{'id': i.id, 'titulo': i.titulo, 'data': i.data,
                    'cliente': i.cliente.nome} for i in ensaios]
        return response
    ...
    def post(self):
        ...
        print(cliente)
        ensaio = Ensaio(titulo=dados['titulo'],
                        data=dados['data'],
                        cliente=cliente)
        print(ensaio)
        ensaio.save()
...
class ListaUsuarios(Resource):
    def get(self):
        ...
        response = [{'id': i.id, 'login':
                    i.login, 'senha':
                    i.senha} for i in usuarios]
        return response
